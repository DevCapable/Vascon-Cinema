        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">IKEJA CINEMA</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Table below shows all movies in Ikeja Cinema</h3>
              </div>
              <!-- /.card-header -->
                ...
                <table id="example2" class="table table-bordered table-hover">
                  <tr>
                    <td colspan="12" id="header">
                      <h2>All Publications on Ikeja <i class=" fa fa-clock"></i> ({{now()}})<h2>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td width="340px">
                      <a onclick="return confirm('Are you sure you want to delete {{$item->full_name}}?')"
                        href="{{url('deleteIkejaCinema/'. $item->id)}}" data-toggle="tooltip"
                        title="Delete Publication Here">
                        <i class="fas fa-trash text-danger fa-lg"> </i></a>|
                      <a  href="{{ url('editIkejaCinema/'.$item->id) }}"
                        title="Edit IkejaCinema Content"> <i class="fas fa-edit btn btn-outline-info fa-lg"> </i></a>|
                        @if ($item->status==='published')
                        <a  href="{{ url('actionOnIkejaCinema/'.$item->id) }}"
                          title="Unpublish IkejaCinema Content"> <i class="fas fa-newspaper btn btn-outline-warning  fa-lg">
                            Unpublish</i></a>
                            @else
                            <a  href="{{ url('actionOnIkejaCinema/'.$item->id) }}"
                              title="Publish IkejaCinema Content"> <i class="fas fa-newspaper btn btn-outline-success  fa-lg">
                                Publish</i></a>
                        @endif
                    </td>
                  </tr>
            ...
            <div class="card">
              ...
              <div class="card card-body bg-transparent">
                <div class="row">
                  <form method="POST" enctype="multipart/form-data" action="{{ route('createIkejaCinema') }}" novalidate>
                    @csrf
                    <div class="row">
                      <div class="col-md-6">
...
@stop
  <script>
    ...
    Toast.fire({
      icon: 'success',
      title: 'Administrator! Here You Can Manage IkejaCinema Content'
    })
  </script>
  <script>
