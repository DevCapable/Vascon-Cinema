  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CONTENT RELATED TO IKEJA BRANCH</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Ikeja</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Table below shows all the Cinema of Ikeja</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body" style="overflow-x:auto;">
                <video width="320" height="240" controls>
                  <source src="{{ asset($ikejaBranch->movie) }}" type="video/mp4" class="img-thumbnail" style="box-shadow: 0px 2px 7px 2px gray ;" alt="VAS Solutions"
            ...
            <div class="card">
              ...
              <div class="card card-body bg-transparent">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('changeIkejaCinemaMovie') }}" novalidate>
                  @csrf
                  <div class="row">
                    <div class="col-md-6">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('updateIkejaCinema') }}" novalidate>
                  @csrf
                  <div class="row">
                    <i style="display: none"> <input type="text" value="{{ $ikejaBranch->id }}" name="id"> </i>
                    <div class="col-md-12">
                      <div class="form-group {{ $errors->has('caption') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="caption" id="caption" class="form-control" value="{{ $ikejaBranch->caption}}"
                    ...
                    <div class="col-md-12">
                      <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                        <div>
                          ...
                          <textarea id="editor" cols="30" rows="10" name="content" >{!!
                            $ikejaBranch->content!!}</textarea>
                        </div>
...
@stop
  <script>
    ...
    Toast.fire({
      icon: 'success',
      title: 'Administrator! Here You Can Edit ikeja Cinema'
    })
  </script>
  <script>
